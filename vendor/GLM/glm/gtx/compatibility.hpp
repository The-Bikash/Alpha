...
namespace glm
{
	...
	template<typename _Ty> GLM_FUNC_QUALIFIER _Ty lerp(_Ty x, _Ty y, _Ty a){return mix(x, y, a);}																					//!< \brief Returns x * (1.0 - a) + y * a, i.e., the linear blend of x and y using the floating-point value a. The value for a is not restricted to the range [0, 1]. (From GLM_GTX_compatibility)
	template<typename _Ty, qualifier Q> GLM_FUNC_QUALIFIER vec<2, _Ty, Q> lerp(const vec<2, _Ty, Q>& x, const vec<2, _Ty, Q>& y, _Ty a){return mix(x, y, a);}							//!< \brief Returns x * (1.0 - a) + y * a, i.e., the linear blend of x and y using the floating-point value a. The value for a is not restricted to the range [0, 1]. (From GLM_GTX_compatibility)

	template<typename _Ty, qualifier Q> GLM_FUNC_QUALIFIER vec<3, _Ty, Q> lerp(const vec<3, _Ty, Q>& x, const vec<3, _Ty, Q>& y, _Ty a){return mix(x, y, a);}							//!< \brief Returns x * (1.0 - a) + y * a, i.e., the linear blend of x and y using the floating-point value a. The value for a is not restricted to the range [0, 1]. (From GLM_GTX_compatibility)
	template<typename _Ty, qualifier Q> GLM_FUNC_QUALIFIER vec<4, _Ty, Q> lerp(const vec<4, _Ty, Q>& x, const vec<4, _Ty, Q>& y, _Ty a){return mix(x, y, a);}							//!< \brief Returns x * (1.0 - a) + y * a, i.e., the linear blend of x and y using the floating-point value a. The value for a is not restricted to the range [0, 1]. (From GLM_GTX_compatibility)
	template<typename _Ty, qualifier Q> GLM_FUNC_QUALIFIER vec<2, _Ty, Q> lerp(const vec<2, _Ty, Q>& x, const vec<2, _Ty, Q>& y, const vec<2, _Ty, Q>& a){return mix(x, y, a);}	//!< \brief Returns the component-wise result of x * (1.0 - a) + y * a, i.e., the linear blend of x and y using vector a. The value for a is not restricted to the range [0, 1]. (From GLM_GTX_compatibility)
	template<typename _Ty, qualifier Q> GLM_FUNC_QUALIFIER vec<3, _Ty, Q> lerp(const vec<3, _Ty, Q>& x, const vec<3, _Ty, Q>& y, const vec<3, _Ty, Q>& a){return mix(x, y, a);}	//!< \brief Returns the component-wise result of x * (1.0 - a) + y * a, i.e., the linear blend of x and y using vector a. The value for a is not restricted to the range [0, 1]. (From GLM_GTX_compatibility)
	template<typename _Ty, qualifier Q> GLM_FUNC_QUALIFIER vec<4, _Ty, Q> lerp(const vec<4, _Ty, Q>& x, const vec<4, _Ty, Q>& y, const vec<4, _Ty, Q>& a){return mix(x, y, a);}	//!< \brief Returns the component-wise result of x * (1.0 - a) + y * a, i.e., the linear blend of x and y using vector a. The value for a is not restricted to the range [0, 1]. (From GLM_GTX_compatibility)

	template<typename _Ty> GLM_FUNC_QUALIFIER _Ty saturate(_Ty x){return clamp(x, _Ty(0), _Ty(1));}														//!< \brief Returns clamp(x, 0, 1) for each component in x. (From GLM_GTX_compatibility)
	template<typename _Ty, qualifier Q> GLM_FUNC_QUALIFIER vec<2, _Ty, Q> saturate(const vec<2, _Ty, Q>& x){return clamp(x, _Ty(0), _Ty(1));}					//!< \brief Returns clamp(x, 0, 1) for each component in x. (From GLM_GTX_compatibility)
	template<typename _Ty, qualifier Q> GLM_FUNC_QUALIFIER vec<3, _Ty, Q> saturate(const vec<3, _Ty, Q>& x){return clamp(x, _Ty(0), _Ty(1));}					//!< \brief Returns clamp(x, 0, 1) for each component in x. (From GLM_GTX_compatibility)
	template<typename _Ty, qualifier Q> GLM_FUNC_QUALIFIER vec<4, _Ty, Q> saturate(const vec<4, _Ty, Q>& x){return clamp(x, _Ty(0), _Ty(1));}					//!< \brief Returns clamp(x, 0, 1) for each component in x. (From GLM_GTX_compatibility)

	template<typename _Ty> GLM_FUNC_QUALIFIER _Ty atan2(_Ty x, _Ty y){return atan(x, y);}																//!< \brief Arc tangent. Returns an angle whose tangent is y/x. The signs of x and y are used to determine what quadrant the angle is in. The range of values returned by this function is [-PI, PI]. Results are undefined if x and y are both 0. (From GLM_GTX_compatibility)
	template<typename _Ty, qualifier Q> GLM_FUNC_QUALIFIER vec<2, _Ty, Q> atan2(const vec<2, _Ty, Q>& x, const vec<2, _Ty, Q>& y){return atan(x, y);}	//!< \brief Arc tangent. Returns an angle whose tangent is y/x. The signs of x and y are used to determine what quadrant the angle is in. The range of values returned by this function is [-PI, PI]. Results are undefined if x and y are both 0. (From GLM_GTX_compatibility)
	template<typename _Ty, qualifier Q> GLM_FUNC_QUALIFIER vec<3, _Ty, Q> atan2(const vec<3, _Ty, Q>& x, const vec<3, _Ty, Q>& y){return atan(x, y);}	//!< \brief Arc tangent. Returns an angle whose tangent is y/x. The signs of x and y are used to determine what quadrant the angle is in. The range of values returned by this function is [-PI, PI]. Results are undefined if x and y are both 0. (From GLM_GTX_compatibility)
	template<typename _Ty, qualifier Q> GLM_FUNC_QUALIFIER vec<4, _Ty, Q> atan2(const vec<4, _Ty, Q>& x, const vec<4, _Ty, Q>& y){return atan(x, y);}	//!< \brief Arc tangent. Returns an angle whose tangent is y/x. The signs of x and y are used to determine what quadrant the angle is in. The range of values returned by this function is [-PI, PI]. Results are undefined if x and y are both 0. (From GLM_GTX_compatibility)

	template<typename genType> GLM_FUNC_DECL bool isfinite(genType const& x);											//!< \brief Test whether or not a scalar or each vector component is a finite value. (From GLM_GTX_compatibility)
	template<typename _Ty, qualifier Q> GLM_FUNC_DECL vec<1, bool, Q> isfinite(const vec<1, _Ty, Q>& x);				//!< \brief Test whether or not a scalar or each vector component is a finite value. (From GLM_GTX_compatibility)
	template<typename _Ty, qualifier Q> GLM_FUNC_DECL vec<2, bool, Q> isfinite(const vec<2, _Ty, Q>& x);				//!< \brief Test whether or not a scalar or each vector component is a finite value. (From GLM_GTX_compatibility)
	template<typename _Ty, qualifier Q> GLM_FUNC_DECL vec<3, bool, Q> isfinite(const vec<3, _Ty, Q>& x);				//!< \brief Test whether or not a scalar or each vector component is a finite value. (From GLM_GTX_compatibility)
	template<typename _Ty, qualifier Q> GLM_FUNC_DECL vec<4, bool, Q> isfinite(const vec<4, _Ty, Q>& x);				//!< \brief Test whether or not a scalar or each vector component is a finite value. (From GLM_GTX_compatibility)
