...
#		elif GLM_CONFIG_ANONYMOUS_STRUCT == GLM_ENABLE
			union
			{
				...
				typename detail::storage<3, _Ty, detail::is_aligned<Q>::value>::type data;
...
#		endif
		...
		GLM_FUNC_DECL GLM_CONSTEXPR vec(vec<3, _Ty, P> const& v);

		// -- Explicit basic constructors --

		GLM_FUNC_DECL GLM_CONSTEXPR explicit vec(_Ty scalar);
		GLM_FUNC_DECL GLM_CONSTEXPR vec(_Ty a, _Ty b, _Ty c);
...
#		endif//GLM_CONFIG_SWIZZLE == GLM_SWIZZLE_OPERATOR
		...
		GLM_FUNC_DECL GLM_CONSTEXPR vec<3, _Ty, Q>& operator=(vec<3, _Ty, Q> const& v) GLM_DEFAULT;

		template<typename U>
		GLM_FUNC_DECL GLM_CONSTEXPR vec<3, _Ty, Q> & operator=(vec<3, U, Q> const& v);
		template<typename U>
		GLM_FUNC_DECL GLM_CONSTEXPR vec<3, _Ty, Q> & operator+=(U scalar);
		template<typename U>
		GLM_FUNC_DECL GLM_CONSTEXPR vec<3, _Ty, Q> & operator+=(vec<1, U, Q> const& v);
		template<typename U>
		GLM_FUNC_DECL GLM_CONSTEXPR vec<3, _Ty, Q> & operator+=(vec<3, U, Q> const& v);
		template<typename U>
		GLM_FUNC_DECL GLM_CONSTEXPR vec<3, _Ty, Q> & operator-=(U scalar);
		...
		GLM_FUNC_DECL GLM_CONSTEXPR vec<3, _Ty, Q> & operator++();
		GLM_FUNC_DECL GLM_CONSTEXPR vec<3, _Ty, Q> & operator--();
		GLM_FUNC_DECL GLM_CONSTEXPR vec<3, _Ty, Q> operator++(int);
		GLM_FUNC_DECL GLM_CONSTEXPR vec<3, _Ty, Q> operator--(int);
	...
	template<typename _Ty, qualifier Q>
	GLM_FUNC_DECL GLM_CONSTEXPR vec<3, _Ty, Q> operator+(vec<3, _Ty, Q> const& v);
	...
	template<typename _Ty, qualifier Q>
	GLM_FUNC_DECL GLM_CONSTEXPR vec<3, _Ty, Q> operator+(vec<3, _Ty, Q> const& v, _Ty scalar);

	template<typename _Ty, qualifier Q>
	GLM_FUNC_DECL GLM_CONSTEXPR vec<3, _Ty, Q> operator+(vec<3, _Ty, Q> const& v, vec<1, _Ty, Q> const& scalar);

	template<typename _Ty, qualifier Q>
	GLM_FUNC_DECL GLM_CONSTEXPR vec<3, _Ty, Q> operator+(_Ty scalar, vec<3, _Ty, Q> const& v);

	template<typename _Ty, qualifier Q>
	GLM_FUNC_DECL GLM_CONSTEXPR vec<3, _Ty, Q> operator+(vec<1, _Ty, Q> const& v1, vec<3, _Ty, Q> const& v2);

	template<typename _Ty, qualifier Q>
	GLM_FUNC_DECL GLM_CONSTEXPR vec<3, _Ty, Q> operator+(vec<3, _Ty, Q> const& v1, vec<3, _Ty, Q> const& v2);

	template<typename _Ty, qualifier Q>
	GLM_FUNC_DECL GLM_CONSTEXPR vec<3, _Ty, Q> operator-(vec<3, _Ty, Q> const& v, _Ty scalar);

	template<typename _Ty, qualifier Q>
	GLM_FUNC_DECL GLM_CONSTEXPR vec<3, _Ty, Q> operator-(vec<3, _Ty, Q> const& v1, vec<1, _Ty, Q> const& v2);
	...
	template<typename _Ty, qualifier Q>
	GLM_FUNC_DECL GLM_CONSTEXPR vec<3, _Ty, Q> operator&(vec<3, _Ty, Q> const& v1, _Ty scalar);
	...
	template<typename _Ty, qualifier Q>
	GLM_FUNC_DECL GLM_CONSTEXPR bool operator==(vec<3, _Ty, Q> const& v1, vec<3, _Ty, Q> const& v2);
