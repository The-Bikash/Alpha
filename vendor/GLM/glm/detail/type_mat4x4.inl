...
#	endif
	...
	GLM_FUNC_QUALIFIER GLM_CONSTEXPR mat<4, 4, _Ty, Q>::mat(mat<4, 4, _Ty, P> const& m)
...
#		endif
	...
	template<typename _Ty, qualifier Q>
	GLM_FUNC_QUALIFIER GLM_CONSTEXPR mat<4, 4, _Ty, Q>::mat(_Ty const& s)
#		if GLM_HAS_INITIALIZER_LISTS
...
#		endif
	...
	template<typename _Ty, qualifier Q>
	GLM_FUNC_QUALIFIER GLM_CONSTEXPR mat<4, 4, _Ty, Q>::mat
	(
		_Ty const& x0, _Ty const& y0, _Ty const& z0, _Ty const& w0,
		_Ty const& x1, _Ty const& y1, _Ty const& z1, _Ty const& w1,
		_Ty const& x2, _Ty const& y2, _Ty const& z2, _Ty const& w2,
		_Ty const& x3, _Ty const& y3, _Ty const& z3, _Ty const& w3
	)
#		if GLM_HAS_INITIALIZER_LISTS
			: value{
...
#		endif
	...
	template<typename _Ty, qualifier Q>
	GLM_FUNC_QUALIFIER GLM_CONSTEXPR mat<4, 4, _Ty, Q>::mat(col_type const& v0, col_type const& v1, col_type const& v2, col_type const& v3)
#		if GLM_HAS_INITIALIZER_LISTS
...
#		endif
	...
	GLM_FUNC_QUALIFIER GLM_CONSTEXPR mat<4, 4, _Ty, Q>::mat(mat<4, 4, U, P> const& m)
#		if GLM_HAS_INITIALIZER_LISTS
			: value{col_type(m[0]), col_type(m[1]), col_type(m[2]), col_type(m[3])}
#		endif
	{
...
#		endif
	...
	GLM_FUNC_QUALIFIER GLM_CONSTEXPR mat<4, 4, _Ty, Q>::mat(vec<4, V1, Q> const& v1, vec<4, V2, Q> const& v2, vec<4, V3, Q> const& v3, vec<4, V4, Q> const& v4)
#		if GLM_HAS_INITIALIZER_LISTS
...
#		endif
	...
	template<typename _Ty, qualifier Q>
	GLM_FUNC_QUALIFIER GLM_CONSTEXPR mat<4, 4, _Ty, Q>::mat(mat<2, 2, _Ty, Q> const& m)
#		if GLM_HAS_INITIALIZER_LISTS
...
#		endif
	...
	template<typename _Ty, qualifier Q>
	GLM_FUNC_QUALIFIER GLM_CONSTEXPR mat<4, 4, _Ty, Q>::mat(mat<3, 3, _Ty, Q> const& m)
#		if GLM_HAS_INITIALIZER_LISTS
...
#		endif
	...
	template<typename _Ty, qualifier Q>
	GLM_FUNC_QUALIFIER GLM_CONSTEXPR mat<4, 4, _Ty, Q>::mat(mat<2, 3, _Ty, Q> const& m)
#		if GLM_HAS_INITIALIZER_LISTS
...
#		endif
	...
	template<typename _Ty, qualifier Q>
	GLM_FUNC_QUALIFIER GLM_CONSTEXPR mat<4, 4, _Ty, Q>::mat(mat<3, 2, _Ty, Q> const& m)
#		if GLM_HAS_INITIALIZER_LISTS
...
#		endif
	...
	template<typename _Ty, qualifier Q>
	GLM_FUNC_QUALIFIER GLM_CONSTEXPR mat<4, 4, _Ty, Q>::mat(mat<2, 4, _Ty, Q> const& m)
#		if GLM_HAS_INITIALIZER_LISTS
...
#		endif
	...
	template<typename _Ty, qualifier Q>
	GLM_FUNC_QUALIFIER GLM_CONSTEXPR mat<4, 4, _Ty, Q>::mat(mat<4, 2, _Ty, Q> const& m)
#		if GLM_HAS_INITIALIZER_LISTS
			: value{col_type(m[0], 0, 0), col_type(m[1], 0, 0), col_type(0, 0, 1, 0), col_type(0, 0, 0, 1)}
#		endif
	{
...
#		endif
	...
	template<typename _Ty, qualifier Q>
	GLM_FUNC_QUALIFIER GLM_CONSTEXPR mat<4, 4, _Ty, Q>::mat(mat<3, 4, _Ty, Q> const& m)
#		if GLM_HAS_INITIALIZER_LISTS
...
#		endif
	...
	template<typename _Ty, qualifier Q>
	GLM_FUNC_QUALIFIER GLM_CONSTEXPR mat<4, 4, _Ty, Q>::mat(mat<4, 3, _Ty, Q> const& m)
#		if GLM_HAS_INITIALIZER_LISTS
...
#		endif
	...
	template<typename _Ty, qualifier Q>
	GLM_FUNC_QUALIFIER typename mat<4, 4, _Ty, Q>::col_type & mat<4, 4, _Ty, Q>::operator[](typename mat<4, 4, _Ty, Q>::length_type i) GLM_NOEXCEPT
	{
	...
	template<typename _Ty, qualifier Q>
	GLM_FUNC_QUALIFIER GLM_CONSTEXPR typename mat<4, 4, _Ty, Q>::col_type const& mat<4, 4, _Ty, Q>::operator[](typename mat<4, 4, _Ty, Q>::length_type i) const GLM_NOEXCEPT
	{
		assert(i < this->length());
		return this->value[i];
	}
	...
	template<typename _Ty, qualifier Q>
	template<typename U>
	GLM_FUNC_QUALIFIER mat<4, 4, _Ty, Q>& mat<4, 4, _Ty, Q>::operator=(mat<4, 4, U, Q> const& m)
	{
	...
	template<typename _Ty, qualifier Q>
	template<typename U>
	GLM_FUNC_QUALIFIER mat<4, 4, _Ty, Q>& mat<4, 4, _Ty, Q>::operator+=(U s)
	{
		this->value[0] += s;
		this->value[1] += s;
		this->value[2] += s;
	...
	template<typename _Ty, qualifier Q>
	GLM_FUNC_QUALIFIER mat<4, 4, _Ty, Q> & mat<4, 4, _Ty, Q>::operator++()
	{
		++this->value[0];
		++this->value[1];
		++this->value[2];
	...
	template<typename _Ty, qualifier Q>
	GLM_FUNC_QUALIFIER mat<4, 4, _Ty, Q> mat<4, 4, _Ty, Q>::operator++(int)
	{
		mat<4, 4, _Ty, Q> Result(*this);
		++*this;
		return Result;
	}
	...
	template<typename _Ty, qualifier Q>
	GLM_FUNC_QUALIFIER mat<4, 4, _Ty, Q> operator+(mat<4, 4, _Ty, Q> const& m)
	{
		return m;
	}
	...
	template<typename _Ty, qualifier Q>
	GLM_FUNC_QUALIFIER mat<4, 4, _Ty, Q> operator+(mat<4, 4, _Ty, Q> const& m, _Ty const& s)
	{
		return mat<4, 4, _Ty, Q>(
			m[0] + s,
			m[1] + s,
	...
	template<typename _Ty, qualifier Q>
	GLM_FUNC_QUALIFIER mat<4, 4, _Ty, Q> operator+(_Ty const& s, mat<4, 4, _Ty, Q> const& m)
	{
		return mat<4, 4, _Ty, Q>(
			m[0] + s,
			m[1] + s,
	...
	template<typename _Ty, qualifier Q>
	GLM_FUNC_QUALIFIER mat<4, 4, _Ty, Q> operator+(mat<4, 4, _Ty, Q> const& m1, mat<4, 4, _Ty, Q> const& m2)
	{
		return mat<4, 4, _Ty, Q>(
			m1[0] + m2[0],
			m1[1] + m2[1],
	...
	template<typename _Ty, qualifier Q>
	GLM_FUNC_QUALIFIER typename mat<4, 4, _Ty, Q>::col_type operator*
	(
		mat<4, 4, _Ty, Q> const& m,
		typename mat<4, 4, _Ty, Q>::row_type const& v
	)
	{
/*
...
*/
		...
		typename mat<4, 4, _Ty, Q>::col_type const Mov0(v[0]);
		typename mat<4, 4, _Ty, Q>::col_type const Mov1(v[1]);
		typename mat<4, 4, _Ty, Q>::col_type const Mul0 = m[0] * Mov0;
		typename mat<4, 4, _Ty, Q>::col_type const Mul1 = m[1] * Mov1;
		typename mat<4, 4, _Ty, Q>::col_type const Add0 = Mul0 + Mul1;
		typename mat<4, 4, _Ty, Q>::col_type const Mov2(v[2]);
		typename mat<4, 4, _Ty, Q>::col_type const Mov3(v[3]);
		typename mat<4, 4, _Ty, Q>::col_type const Mul2 = m[2] * Mov2;
		typename mat<4, 4, _Ty, Q>::col_type const Mul3 = m[3] * Mov3;
		typename mat<4, 4, _Ty, Q>::col_type const Add1 = Mul2 + Mul3;
		typename mat<4, 4, _Ty, Q>::col_type const Add2 = Add0 + Add1;
		return Add2;
...
*/
	...
	template<typename _Ty, qualifier Q>
	GLM_FUNC_QUALIFIER typename mat<4, 4, _Ty, Q>::row_type operator*
	(
		typename mat<4, 4, _Ty, Q>::col_type const& v,
		mat<4, 4, _Ty, Q> const& m
	)
	{
		return typename mat<4, 4, _Ty, Q>::row_type(
	...
	template<typename _Ty, qualifier Q>
	GLM_FUNC_QUALIFIER mat<2, 4, _Ty, Q> operator*(mat<4, 4, _Ty, Q> const& m1, mat<2, 4, _Ty, Q> const& m2)
	{
	...
	template<typename _Ty, qualifier Q>
	GLM_FUNC_QUALIFIER mat<3, 4, _Ty, Q> operator*(mat<4, 4, _Ty, Q> const& m1, mat<3, 4, _Ty, Q> const& m2)
	{
	...
	GLM_FUNC_QUALIFIER mat<4, 4, _Ty, Q> operator*(mat<4, 4, _Ty, Q> const& m1, mat<4, 4, _Ty, Q> const& m2)
	{
		typename mat<4, 4, _Ty, Q>::col_type const SrcA0 = m1[0];
		typename mat<4, 4, _Ty, Q>::col_type const SrcA1 = m1[1];
		typename mat<4, 4, _Ty, Q>::col_type const SrcA2 = m1[2];
		typename mat<4, 4, _Ty, Q>::col_type const SrcA3 = m1[3];

		typename mat<4, 4, _Ty, Q>::col_type const SrcB0 = m2[0];
		typename mat<4, 4, _Ty, Q>::col_type const SrcB1 = m2[1];
		typename mat<4, 4, _Ty, Q>::col_type const SrcB2 = m2[2];
		typename mat<4, 4, _Ty, Q>::col_type const SrcB3 = m2[3];
	...
	template<typename _Ty, qualifier Q>
	GLM_FUNC_QUALIFIER typename mat<4, 4, _Ty, Q>::col_type operator/(mat<4, 4, _Ty, Q> const& m, typename mat<4, 4, _Ty, Q>::row_type const& v)
	{
		return inverse(m) * v;
	}

	template<typename _Ty, qualifier Q>
	GLM_FUNC_QUALIFIER typename mat<4, 4, _Ty, Q>::row_type operator/(typename mat<4, 4, _Ty, Q>::col_type const& v, mat<4, 4, _Ty, Q> const& m)
	{
		return v * inverse(m);
	}
	...
	template<typename _Ty, qualifier Q>
	GLM_FUNC_QUALIFIER bool operator==(mat<4, 4, _Ty, Q> const& m1, mat<4, 4, _Ty, Q> const& m2)
	{
