...
namespace glm
{
	...
	GLM_FUNC_DECL vec<L, _Ty, Q> nextFloat(vec<L, _Ty, Q> const& x);
	...
	/// @see ext_scalar_ulp
	template<length_t L, typename _Ty, qualifier Q>
	GLM_FUNC_DECL vec<L, _Ty, Q> nextFloat(vec<L, _Ty, Q> const& x, int ULPs);
	...
	/// @see ext_scalar_ulp
	template<length_t L, typename _Ty, qualifier Q>
	GLM_FUNC_DECL vec<L, _Ty, Q> nextFloat(vec<L, _Ty, Q> const& x, vec<L, int, Q> const& ULPs);
	...
	/// @see ext_scalar_ulp
	template<length_t L, typename _Ty, qualifier Q>
	GLM_FUNC_DECL vec<L, _Ty, Q> prevFloat(vec<L, _Ty, Q> const& x);
	...
	/// @see ext_scalar_ulp
	template<length_t L, typename _Ty, qualifier Q>
	GLM_FUNC_DECL vec<L, _Ty, Q> prevFloat(vec<L, _Ty, Q> const& x, int ULPs);
	...
	/// @see ext_scalar_ulp
	template<length_t L, typename _Ty, qualifier Q>
	GLM_FUNC_DECL vec<L, _Ty, Q> prevFloat(vec<L, _Ty, Q> const& x, vec<L, int, Q> const& ULPs);
